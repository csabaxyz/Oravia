...
=== "Grammar"
    ...
    ```
    I ilianum canon i anye.
    ```
    
    ```
    Nim i anitar caora i anifou.
    ```
    
    ```
    Caora toului, i fou i anepou.
    ```
    ...
    **Tips**
    ...
    <p style="margin: 0 0 0.5rem 0;">How many people come on Monday?</p>
    <p style="margin: 0 0 0.5rem 0;"> How much is this event? </p>
    <p style="margin: 0 0 0.5rem 0;">Why you all don't like the decoration?</p>
    <p style="margin: 0 0 0.5rem 0;">How are you? Good?</p>
    <p style="margin: 0 0 0.5rem 0;">I don't know how to do it.</p>
    <p style="margin: 0 0 0.5rem 0;">I took it because I need it.</p>
    <p style="margin: 0 0 0.5rem 0;">Since I am tired, I need to stop.</p>
    </div>
...
=== "Exercise 1"
    ...
    **If you don't remember or make a mistake, that's totally fine!** We will have plenty of opportunities to practice. Right now just give it a try.
    ...
    ### Round 5
    <div id="matching-game-5" data-lesson="lesson28_b" data-round="5"></div>

    ---

    ### Round 6
    <div id="matching-game-6" data-lesson="lesson28_b" data-round="6"></div>

    ---

    ### Round 7
    <div id="matching-game-7" data-lesson="lesson28_b" data-round="7"></div>

    ---

    ### Round 8
    <div id="matching-game-8" data-lesson="lesson28_b" data-round="8"></div>
...
=== "Exercise 2"
    ...
    **If you don't remember or make a mistake, that's totally fine!** We will have plenty of opportunities to practice. Right now just give it a try.
    ...
    ---
    ### Round 1
    <div id="matching-game-9" data-lesson="lesson26_exercise2" data-round="1"></div>

    ---

    ### Round 2
    <div id="matching-game-10" data-lesson="lesson26_exercise2" data-round="2"></div>

    ---

    ### Round 3
    <div id="matching-game-11" data-lesson="lesson26_exercise2" data-round="3"></div>

    ---

    ### Round 4
    <div id="matching-game-12" data-lesson="lesson26_exercise2" data-round="4"></div>

    ---

    ### Round 5
    <div id="matching-game-13" data-lesson="lesson26_exercise2" data-round="5"></div>

    ---

    ### Round 6
    <div id="matching-game-14" data-lesson="lesson26_exercise2" data-round="6"></div>

    ---

    ### Round 7
    <div id="matching-game-15" data-lesson="lesson26_exercise2" data-round="7"></div>
...
function initWarmup() {
    const warmupWords = [
    {id: "be_g1", oravia: "bejae", english: "luggage"},
    {id: "be_g2", oravia: "bevio", english: "shop"},
    {id: "be_g3", oravia: "bedam", english: "square"},
    {id: "be_g4", oravia: "bejui", english: "rent"},
    {id: "be_i1", oravia: "beitor", english: "bicycle"},
    {id: "be_i2", oravia: "beivu", english: "car"},
    {id: "be_i3", oravia: "beilem", english: "station"},
    {id: "be_i4", oravia: "beitan", english: "bus"},
    ];
