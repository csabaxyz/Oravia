...
=== "Grammar"
    ...
    When we answer a question about quantity, we can reply a specific number, or just say *mir*. *Mir* means *many*, that's why we have words like *yamirli* = old.
    We can also use *mir* to indicate plural, like *mir falen* = children.
...
=== "Vocabulary"
    ...
    <p style="margin: 0;">Example answers: Cali i anopuar e yunitam, a nim a tohpu. Nim i tohnaru. I nomie no tovei.</p>
    </div>
...
=== "Exercise 1"
    ...
    **If you don't remember or make a mistake, that's totally fine!** We will have plenty of opportunities to practice. Right now just give it a try.
    ...
    ---
    ### Round 1
    <div id="matching-game-1" data-lesson="lesson28" data-round="1"></div>

    ---

    ### Round 2
    <div id="matching-game-2" data-lesson="lesson28" data-round="2"></div>

    ---

    ### Round 3
    <div id="matching-game-3" data-lesson="lesson28" data-round="3"></div>

    ---

    ### Round 4
    <div id="matching-game-4" data-lesson="lesson28" data-round="4"></div>

    ---

    ### Round 5
    <div id="matching-game-5" data-lesson="lesson28" data-round="5"></div>
...
=== "Exercise 2"
    ...
    **If you don't remember or make a mistake, that's totally fine!** We will have plenty of opportunities to practice. Right now just give it a try.
    ...
    ---
    ### Round 1
    <div id="matching-game-6" data-lesson="lesson26_exercise2" data-round="1"></div>

    ---

    ### Round 2
    <div id="matching-game-7" data-lesson="lesson26_exercise2" data-round="2"></div>

    ---

    ### Round 3
    <div id="matching-game-8" data-lesson="lesson26_exercise2" data-round="3"></div>

    ---

    ### Round 4
    <div id="matching-game-9" data-lesson="lesson26_exercise2" data-round="4"></div>

    ---

    ### Round 5
    <div id="matching-game-10" data-lesson="lesson26_exercise2" data-round="5"></div>

    ---

    ### Round 6
    <div id="matching-game-11" data-lesson="lesson26_exercise2" data-round="6"></div>

    ---

    ### Round 7
    <div id="matching-game-12" data-lesson="lesson26_exercise2" data-round="7"></div>
...
function initWarmup() {
    const warmupWords = [
    {id: "oi_f1", oravia: "oifu", english: "silly"},
    {id: "oi_f2", oravia: "oines", english: "joke"},
    {id: "oi_f3", oravia: "oipili", english: "cute"},
    {id: "oi_s1", oravia: "oimel", english: "story"},
    {id: "oi_s2", oravia: "oihi", english: "interest"},
    {id: "oi_s3", oravia: "oipoh", english: "excitement"},
    {id: "oi_s4", oravia: "oila", english: "happy"},
    ];
...
<div style="text-align: center; padding: 2rem 0; background: #e0f2f1; border-radius: 8px; margin-top: 3rem;">
    <p style="font-size: 1.2rem; color: #4a9cd6; margin-bottom: 1rem;">
        🎉 <strong>Lesson 17 Complete!</strong>
    </p>
