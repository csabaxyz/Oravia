# Lesson 32: Should & Must / RO Cluster
...
=== "Grammar"
    ...
    Today we will learn how to say someone should or must do something. 
    First, let's take a look at *should*. We use **daetane**, which means **recommendation**.
    ...
    Notice that two negatives are possible:
    
    ```
    Fano i taneum i mo.
    There is no recommendation that the child eat.  
    
    Fano i tane i moum.
    It's recommended that the child not eat. 
    ```
    ...
    Once again, two types of negative are possible:
    ```
    A eodenbor i vilum i gerina.
    There is no obligation for the visit to pay.   
    
    Fare i vil i ilonosum e fano.
    Parents have an obligation not to forget their kids. 
    ```
...
=== "Vocabulary"
    ...
    Today, let's take a look at the **RO** cluster!
    
    | Oravia | English |
    |--------|---------|
    | rovir | science, research |
    | roejo | exam |
    | roesau | learn, study |
    | roedom | school |
    | roena | teach |
    ...
    What do you think **RO** words are about? 
    ...
    <p style="margin: 0;"> They are about <strong>knowledge</strong>! </p>
    </div>
    
    
    How about the subclusters? Which ones do you see and what do you think they mean?
    ...
    <p style="margin: 0;"> We have two subclusters. <strong>ROE</strong> is about <strong>formal education</strong>, and <strong>ROU</strong> is about <strong>written knowledge</strong>. </p>
    </div>
    
    !!! tip "Sound Connections"
        We've seen a couple of words with the root *dom*, like *gedom* as *bank* and *roedom* as *school*. What does *dom* mean?
        Also, take a look at words such as *roena* as *teach* and *roesau* as *learn*. Do you recognize these roots from *AN* cluster words? What do they mean?
        How about words like *roumir* as *book* and *roudi* as *write*, do you recognize these sounds from previous words?
    
    Now try to write 3 sentences using **RO** words:
...
=== "Exercise 1"
    ...
    **If you don't remember or make a mistake, that's totally fine!** We will have plenty of opportunities to practice. Right now just give it a try.
    ...
    <div id="matching-game-1" data-lesson="lesson32" data-round="1"></div>

    ---

    ### Round 2

    <div id="matching-game-2" data-lesson="lesson32" data-round="2"></div>

    ---

    ### Round 3

    <div id="matching-game-3" data-lesson="lesson32" data-round="3"></div>
...
=== "Exercise 2"
    ...
    **If you don't remember or make a mistake, that's totally fine!** We will have plenty of opportunities to practice. Right now just give it a try.
    ...
    <div id="matching-game-4" data-lesson="lesson30_exercise2" data-round="1"></div>

    ---

    ### Round 2

    <div id="matching-game-5" data-lesson="lesson30_exercise2" data-round="2"></div>

    ---

    ### Round 3

    <div id="matching-game-6" data-lesson="lesson30_exercise2" data-round="3"></div>

    ---

    ### Round 4

    <div id="matching-game-7" data-lesson="lesson30_exercise2" data-round="4"></div>
...
function initWarmup() {
        const warmupWords = [
    {id: "no_1", oravia: "notane", english: "should"},
    {id: "no_2", oravia: "no",     english: "like, as"},
    {id: "no_3", oravia: "noniu",  english: "some"},
    {id: "no_4", oravia: "noi",    english: "here"},
    {id: "no_5", oravia: "noli",   english: "now"},
    {id: "no_6", oravia: "nomie",  english: "seems"},
    {id: "no_7", oravia: "nordau", english: "far"},
    ];
...
<div style="text-align: center; padding: 2rem 0; background: #e0f2f1; border-radius: 8px; margin-top: 3rem;">
    <p style="font-size: 1.2rem; color: #4a9cd6; margin-bottom: 1rem;">
        🎉 <strong>Lesson 32 Complete!</strong>
    </p>
    ...
    <p style="color: #5a8bb8; margin-bottom: 1.5rem;">
        Come back tomorrow for Lesson 33.
    </p>
</div>
