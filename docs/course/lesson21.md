...
=== "Grammar"
    ...
    ```
    Hay i daiar i bortal, mai i anelemum. 
    ```
    ...
    ```
    Haye faibor i anifis, eta nim i fou i boemo.
    ```
    
    ```
    Nim i doar i anocari, mai i daium. 
    ```
    ...
    **Tips**
    ...
    <p style="margin: 0 0 0.5rem 0;">Yesterday, I ate chocolate.</p>
    <p style="margin: 0 0 0.5rem 0;">Tomorrow, we will go to the plaza.</p>
    <p style="margin: 0 0 0.5rem 0;">He wanted to enter, but didn't stay. (maybe a cat!)</p>
    <p style="margin: 0 0 0.5rem 0;">Your nephew will be tall.</p>
    <p style="margin: 0 0 0.5rem 0;">My future restaurant will be big. </p>
    <p style="margin: 0;"> Their spouse is going to come, so I have to cook.</p>
    <p style="margin: 0;"> I was able to leave, but I didn't want to.</p>
    <p style="margin: 0;"> I had eaten when you arrived.</p>
    </div>
...
=== "Vocabulary"
    ...
    <p style="margin: 0;">The <strong>VA</strong> words are about the <strong>body parts</strong>. VA means body. </p>
    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    Promise.all([
        fetch(baseUrl + '/data/lesson22_words.json').then(r => r.json()),
