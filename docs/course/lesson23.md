...
=== "Grammar"
    ...
    ```
    Tamen liperi, i vanvuis en bedam.
    ```
    
    ```
    Perien, fano i vanpaiar e haye eofa lili. 
    ```
    
    ```
    I vardurar e varluan!
    ```
    
    ```
    Lipardas auta, i dami a eompela en nime bo.
    ```
    
    ```
    A nime favi litam a lipardas alui.
    ```
    
    ```
    I anidaium e varsi ilhei, mai i anidai cali haye i anisu e oico!
    ```
    
    ```
    I varsus! Nim i vanta e anona u runa. Mai, bi oifu, a anona a moum! 
    ```
    ...
    **Tips**
    ...
    <p style="margin: 0 0 0.5rem 0;">On Monday, I will walk to the plaza.</p>
    <p style="margin: 0 0 0.5rem 0;">On Sunday, my child kicked their friend again.</p>
    <p style="margin: 0 0 0.5rem 0;">I bit my tongue!</p>
    <p style="margin: 0 0 0.5rem 0;">In August, there will be a party in my house.</p>
    <p style="margin: 0;"> My birthday is in April.</p>
    <p style="margin: 0 0 0.5rem 0;">I don't like meddlesome people, but I like it when they bring gossip! </p>
    <p style="margin: 0;"> Listen! I have gifts for you all. But, silly: the gift is not food!</p>
    </div>
...
=== "Vocabulary"
    ...
    So let's take a look at three words in this cluster.
    First, *no* means *such, as, like*. For example:
    ...
    ```
    ho noi i dami a moaria = there is an apple there
    ho noi moaria = the there apple = that apple
    ```
...
function initWarmup() {
    const warmupWords = [
    {id: "eo_b1", oravia: "eoren", english: "miss"},
    {id: "eo_b2", oravia: "eori", english: "love"},
    {id: "eo_b3", oravia: "eopan", english: "jealous"},
    {id: "eo_b4", oravia: "eomio", english: "support"},
    {id: "eo_b5", oravia: "eodani", english: "trust"},
    {id: "eo_b6", oravia: "eodya", english: "proud"},
    ];
