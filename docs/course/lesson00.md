...
=== "Pronunciation Guide"
    ...
    **Examples:**
    ...
    The preference is pronouncing it as **one syllable** (as in o**RA**via), but could be two.
...
=== "Vocabulary Structure"
    ...
    **The semantic clusters help learn and remember the vocabulary**, because it's easier to make associations.
    ...
    <div style="text-align: center; margin: 2rem 0;">
        <button onclick="document.getElementById('mio-answer').style.display='block'; this.style.display='none';"
                style="background: #4a9cd6; color: white; border: none; padding: 0.75rem 2rem; border-radius: 4px; cursor: pointer;">
            Click to Reveal Subcluster Meaning
        </button>
    </div>

    <div id="mio-answer" style="display: none; background: #c8e6c9; padding: 1.5rem; border-left: 4px solid #43a047; border-radius: 4px; margin: 2rem 0;">
        <p style="margin: 0;">All words that start with <strong>MIO</strong> indicate <strong>wild animals</strong>.</p>
    </div>
...
<div style="text-align: center; padding: 2rem 0;">
  <p style="font-size: 1.1rem; color: #4a9cd6;">
    After checking the Pronunciation Guide and Vocabulary Structure, you are ready to start the course!
  </p>
  <a href="../lesson01" class="md-button md-button--primary">Continue to Lesson 1 →</a>
</div>
