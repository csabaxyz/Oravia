...
=== "Grammar"
    ...
    **Tips**
    ...
    <p style="margin: 0 0 0.5rem 0;">This car is the fastest. </p>
    <p style="margin: 0 0 0.5rem 0;">I want the newest table. </p>
    <p style="margin: 0 0 0.5rem 0;">My house is big compared to yours, but yours is comfortable compared to mine. </p>
    <p style="margin: 0 0 0.5rem 0;">My mom's food is the best. </p>
    <p style="margin: 0 0 0.5rem 0;">They talk much compared to you. / They talk more than you.</p>
    <p style="margin: 0 0 0.5rem 0;">Compared to kids, adults are lazy. / Adults are lazier than kids. </p>
    </div>
...
=== "Exercise 2"
    ...
    **If you don't remember or make a mistake, that's totally fine!** We will have plenty of opportunities to practice. Right now just give it a try.
    ...
    <div id="matching-game-4" data-lesson="lesson28_exercise2" data-round="1"></div>

    ---

    ### Round 2

    <div id="matching-game-5" data-lesson="lesson28_exercise2" data-round="2"></div>

    ---

    ### Round 3

    <div id="matching-game-6" data-lesson="lesson28_exercise2" data-round="3"></div>

    ---

    ### Round 4

    <div id="matching-game-7" data-lesson="lesson28_exercise2" data-round="4"></div>

    ---

    ### Round 5

    <div id="matching-game-8" data-lesson="lesson28_exercise2" data-round="5"></div>
...
function initWarmup() {
        const warmupWords = [
    {id: "va_9", oravia: "vavari",  english: "back"},
    {id: "va_4", oravia: "varmo",   english: "mouth"},
    {id: "va_7", oravia: "vanpai",  english: "foot"},
    {id: "va_2", oravia: "varluan", english: "tongue"},
    {id: "va_6", oravia: "vanta",   english: "hand"},
    {id: "va_1", oravia: "vardei",  english: "eye"},
    {id: "va_8", oravia: "vanvu",   english: "leg"},
    {id: "va_3", oravia: "varsus",  english: "ear"},
    {id: "va_5", oravia: "vano",    english: "arm"},
    ];
...
<div style="text-align: center; padding: 2rem 0; background: #e0f2f1; border-radius: 8px; margin-top: 3rem;">
    <p style="font-size: 1.2rem; color: #4a9cd6; margin-bottom: 1rem;">
        🎉 <strong>Lesson 31 Complete!</strong>
    </p>
