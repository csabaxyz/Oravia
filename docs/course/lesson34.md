...
=== "Vocabulary"
    ...
    <p style="margin: 0;"> They are <strong>wild animals</strong>! <strong>MIO</strong> means <strong>wild</strong>.</p>
    </div>
    ...
    <p style="margin: 0;">Possible translation: What is your favorite (bigger) animal?</p>
    </div>
...
=== "Exercise 1"
    ...
    **If you don't remember or make a mistake, that's totally fine!** We will have plenty of opportunities to practice. Right now just give it a try.
    ...
    <div id="matching-game-1" data-lesson="lesson34" data-round="1"></div>

    ---

    ### Round 2

    <div id="matching-game-2" data-lesson="lesson34" data-round="2"></div>

    ---

    ### Round 3

    <div id="matching-game-3" data-lesson="lesson34" data-round="3"></div>
...
=== "Exercise 2"
    ...
    **If you don't remember or make a mistake, that's totally fine!** We will have plenty of opportunities to practice. Right now just give it a try.
    ...
    <div id="matching-game-4" data-lesson="lesson32_exercise2" data-round="1"></div>

    ---

    ### Round 2

    <div id="matching-game-5" data-lesson="lesson32_exercise2" data-round="2"></div>

    ---

    ### Round 3

    <div id="matching-game-6" data-lesson="lesson32_exercise2" data-round="3"></div>

    ---

    ### Round 4

    <div id="matching-game-7" data-lesson="lesson32_exercise2" data-round="4"></div>

    ---

    ### Round 5

    <div id="matching-game-8" data-lesson="lesson32_exercise2" data-round="5"></div>
...
function initWarmup() {
        const warmupWords = [
    {id: "yu_1", oravia: "yuvabo",  english: "comfortable"},
    {id: "yu_2", oravia: "yuba",    english: "good"},
    {id: "yu_3", oravia: "yudur",   english: "hard"},
    {id: "yu_4", oravia: "yunmir",  english: "rich"},
    {id: "yu_5", oravia: "yunro",   english: "smart"},
    {id: "yu_6", oravia: "yunitam", english: "special"},
    {id: "yu_7", oravia: "yunrani", english: "beautiful"},
    ];
...
<div style="text-align: center; padding: 2rem 0; background: #e0f2f1; border-radius: 8px; margin-top: 3rem;">
    <p style="font-size: 1.2rem; color: #4a9cd6; margin-bottom: 1rem;">
        🎉 <strong>Lesson 34 Complete!</strong>
    </p>
    ...
    <p style="color: #5a8bb8; margin-bottom: 1.5rem;">
        Come back tomorrow for Lesson 35.
    </p>
</div>
