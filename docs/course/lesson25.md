...
=== "Grammar"
    ...
    ```
    A anye hai eofa i ansau e yani bevio. 
    ```
...
=== "Vocabulary"
    ...
    Today we will learn our next cluster, **YU**!
    ...
    What do you think the **YU** cluster is about? 
    ...
    <p style="margin: 0;"> Subjective qualities. </p>
    </div>
    ...
    Now try to create 3 sentences using **YU** words:
...
=== "Exercise 1"
    ...
    **If you don't remember or make a mistake, that's totally fine!** We will have plenty of opportunities to practice. Right now just give it a try.
    ...
    ---
    ### Round 1
    <div id="matching-game-1" data-lesson="lesson24_b" data-round="1"></div>

    ---

    ### Round 2
    <div id="matching-game-2" data-lesson="lesson24_b" data-round="2"></div>

    ---

    ### Round 3
    <div id="matching-game-3" data-lesson="lesson24_b" data-round="3"></div>

    ---

    ### Round 4
    <div id="matching-game-4" data-lesson="lesson24_b" data-round="4"></div>

    ---

    ### Round 5
    <div id="matching-game-5" data-lesson="lesson24_b" data-round="5"></div>

    ---

    ### Round 6
    <div id="matching-game-6" data-lesson="lesson24_b" data-round="6"></div>

    ---

    ### Round 7
    <div id="matching-game-7" data-lesson="lesson24_b" data-round="7"></div>
...
=== "Exercise 2"
    ...
    **If you don't remember or make a mistake, that's totally fine!** We will have plenty of opportunities to practice. Right now just give it a try.
    ...
    ---
    ### Round 1
    <div id="matching-game-8" data-lesson="lesson22_exercise2" data-round="1"></div>

    ---

    ### Round 2
    <div id="matching-game-9" data-lesson="lesson22_exercise2" data-round="2"></div>

    ---

    ### Round 3
    <div id="matching-game-10" data-lesson="lesson22_exercise2" data-round="3"></div>

    ---

    ### Round 4
    <div id="matching-game-11" data-lesson="lesson22_exercise2" data-round="4"></div>

    ---

    ### Round 5
    <div id="matching-game-12" data-lesson="lesson22_exercise2" data-round="5"></div>

    ---

    ### Round 6
    <div id="matching-game-13" data-lesson="lesson22_exercise2" data-round="6"></div>

    ---

    ### Round 7
    <div id="matching-game-14" data-lesson="lesson22_exercise2" data-round="7"></div>

    ---

    ### Round 8
    <div id="matching-game-15" data-lesson="lesson22_exercise2" data-round="8"></div>

    ---

    ### Round 9
    <div id="matching-game-16" data-lesson="lesson22_exercise2" data-round="9"></div>
...
function initWarmup() {
    const warmupWords = [
    {id: "g_2", oravia: "gelna", english: "buy"},
    {id: "j_3", oravia: "das", english: "10"},
    {id: "g_4", oravia: "geldove", english: "sell"},
    {id: "j_1", oravia: "auta", english: "8"},
    {id: "g_1", oravia: "gerina", english: "money"},
    {id: "j_2", oravia: "teda", english: "9"},
    {id: "g_3", oravia: "gelsar", english: "bill"},
    ];
