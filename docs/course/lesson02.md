...
=== "Grammar"
    ...
    **a** indicates the **subject**, usually who is doing the action. You may say,
    ...
    <div id="subcluster-answer" style="display: none; background: #c8e6c9; padding: 1.5rem; border-left: 4px solid #43a047; border-radius: 4px; margin: 2rem 0;">
        <p style="margin: 0;">There are multiple ways to say it, for example: a hay i mo e mocen; a nim i mouje e mocen.</p>
    </div>
...
=== "Exercise 2"
    ...
    **If you don't remember or make a mistake, that's totally fine!** We will have plenty of opportunities to practice. Right now just give it a try.
    ...
    <div id="matching-game-5" data-lesson="lesson02_exercise2" data-round="1"></div>

    ---

    ### Round 2

    <div id="matching-game-6" data-lesson="lesson02_exercise2" data-round="2"></div>

    ---

    ### Round 3

    <div id="matching-game-7" data-lesson="lesson02_exercise2" data-round="3"></div>
