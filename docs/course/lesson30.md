...
=== "Grammar"
    ...
    Today we will learn how to make comparisons. There are two types of comparison. In the first, we are comparing two things with each other. For example, when you say "your child is taller than my child".
    ...
    <p style="margin: 0;">Possible translation: Among your family members, what personal characteristic are you the top in? What objective trait you have more than your siblings?</p>
    </div>
...
=== "Exercise 1"
    ...
    **If you don't remember or make a mistake, that's totally fine!** We will have plenty of opportunities to practice. Right now just give it a try.
    ...
    ### Round 4
    <div id="matching-game-4" data-lesson="lesson30" data-round="4"></div>
...
=== "Exercise 2"
    ...
    **If you don't remember or make a mistake, that's totally fine!** We will have plenty of opportunities to practice. Right now just give it a try.
    ...
    ---
    ### Round 1
    <div id="matching-game-5" data-lesson="lesson28_exercise2" data-round="1"></div>

    ---

    ### Round 2
    <div id="matching-game-6" data-lesson="lesson28_exercise2" data-round="2"></div>

    ---

    ### Round 3
    <div id="matching-game-7" data-lesson="lesson28_exercise2" data-round="3"></div>

    ---

    ### Round 4
    <div id="matching-game-8" data-lesson="lesson28_exercise2" data-round="4"></div>

    ---

    ### Round 5
    <div id="matching-game-9" data-lesson="lesson28_exercise2" data-round="5"></div>

    ---

    ### Round 6
    <div id="matching-game-10" data-lesson="lesson28_exercise2" data-round="6"></div>

    ---

    ### Round 7
    <div id="matching-game-11" data-lesson="lesson28_exercise2" data-round="7"></div>

    ---

    ### Round 8
    <div id="matching-game-12" data-lesson="lesson28_exercise2" data-round="8"></div>
...
function initWarmup() {
    const warmupWords = [
    {id: "va_r1", oravia: "varsi", english: "nose"},
    {id: "va_r2", oravia: "vardei", english: "eye"},
    {id: "va_r3", oravia: "varsus", english: "ear"},
    {id: "va_r4", oravia: "varmo", english: "mouth"},
    {id: "va_r5", oravia: "varluan", english: "tongue"},
    {id: "va_r6", oravia: "varodu", english: "head"},
    {id: "va_r7", oravia: "vardur", english: "tooth"},
    ];
