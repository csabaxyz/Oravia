...
=== "Grammar"
    ...
    To say **each other** we use **cemi**, like this:
...
=== "Vocabulary"
    ...
    <p style="margin: 0;"> The subcluster <strong>YES</strong> is about <strong>clothes</strong>.</p>
    </div>
...
=== "Exercise 1"
    ...
    **If you don't remember or make a mistake, that's totally fine!** We will have plenty of opportunities to practice. Right now just give it a try.
    ...
    ---
    ### Round 1
    <div id="matching-game-1" data-lesson="lesson36" data-round="1"></div>

    ---

    ### Round 2
    <div id="matching-game-2" data-lesson="lesson36" data-round="2"></div>

    ---

    ### Round 3
    <div id="matching-game-3" data-lesson="lesson36" data-round="3"></div>

    ---

    ### Round 4
    <div id="matching-game-4" data-lesson="lesson36" data-round="4"></div>

    ---

    ### Round 5
    <div id="matching-game-5" data-lesson="lesson36" data-round="5"></div>

    ---

    ### Round 6
    <div id="matching-game-6" data-lesson="lesson36" data-round="6"></div>
...
=== "Exercise 2"
    ...
    **If you don't remember or make a mistake, that's totally fine!** We will have plenty of opportunities to practice. Right now just give it a try.
    ...
    ---
    ### Round 1
    <div id="matching-game-7" data-lesson="lesson34_exercise2" data-round="1"></div>

    ---

    ### Round 2
    <div id="matching-game-8" data-lesson="lesson34_exercise2" data-round="2"></div>

    ---

    ### Round 3
    <div id="matching-game-9" data-lesson="lesson34_exercise2" data-round="3"></div>

    ---

    ### Round 4
    <div id="matching-game-10" data-lesson="lesson34_exercise2" data-round="4"></div>

    ---

    ### Round 5
    <div id="matching-game-11" data-lesson="lesson34_exercise2" data-round="5"></div>

    ---

    ### Round 6
    <div id="matching-game-12" data-lesson="lesson34_exercise2" data-round="6"></div>

    ---

    ### Round 7
    <div id="matching-game-13" data-lesson="lesson34_exercise2" data-round="7"></div>

    ---

    ### Round 8
    <div id="matching-game-14" data-lesson="lesson34_exercise2" data-round="8"></div>
...
function initWarmup() {
    const warmupWords = [
    {id: "to_h1", oravia: "tohpu", english: "sad"},
    {id: "to_h2", oravia: "tohnaru", english: "anger"},
    {id: "to_u1", oravia: "tounir", english: "weak"},
    {id: "to_u2", oravia: "toului", english: "tired"},
    {id: "to_b1", oravia: "towa", english: "thirst"},
    {id: "to_b2", oravia: "tovei", english: "illness"},
    ];
