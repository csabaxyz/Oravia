...
=== "Grammar"
    ...
    ```
    Ilicei a nime miwo a fani. Bi oipili!
    ```
    ...
    ```
    Ilicei hay i roesau, a roejo a yugai.
    ```
    ...
    ```
    Ilicei nim i bontamear, i ilian cadom.   
    ```
    
    ```
    Ilicei nim i moarum, noli a toumo.   
    ```
    ...
    **Tips**
    ...
    <p style="margin: 0 0 0.5rem 0;"> Assume: it's winter, so it's cold. / If it's winter it's cold. </p>
    <p style="margin: 0 0 0.5rem 0;"> Imagine: my dog is a puppy. How cute! </p>
    <p style="margin: 0 0 0.5rem 0;"> Assume: kid writes, so they know how to read. / If the kid can write, then they know how to read. </p>
    <p style="margin: 0 0 0.5rem 0;"> Imagine: he studies, the exam is easy. / If he studied, the exam would be easy. </p>
    <p style="margin: 0 0 0.5rem 0;"> Assume: she is hungry, she eats. / If she is hungry, she will eat. </p>
    <p style="margin: 0 0 0.5rem 0;"> Imagine: I am the teacher, I know the exam. / If I were the teacher, I would know the exam. </p>
    <p style="margin: 0 0 0.5rem 0;"> Imagine: I put on the table, I know where. / If I had put it on the table, I would know where it is. </p>
    <p style="margin: 0 0 0.5rem 0;"> Imagine: I didn't eat, now hungry. / If I hadn't eaten, now I would be hungry. </p>
    </div>
...
=== "Vocabulary"
    ...
    Today we will learn our 20th cluster, **YE*! Take a look at the words below:
    ...
    What do you think the **YE** cluster is about? 
    ...
    <p style="margin: 0;"> Clothing and fabric! </p>
    </div>
...
=== "Exercise 1"
    ...
    **If you don't remember or make a mistake, that's totally fine!** We will have plenty of opportunities to practice. Right now just give it a try.
    ...
    ---
    ### Round 1
    <div id="matching-game-1" data-lesson="lesson34_b" data-round="1"></div>

    ---

    ### Round 2
    <div id="matching-game-2" data-lesson="lesson34_b" data-round="2"></div>

    ---

    ### Round 3
    <div id="matching-game-3" data-lesson="lesson34_b" data-round="3"></div>

    ---

    ### Round 4
    <div id="matching-game-4" data-lesson="lesson34_b" data-round="4"></div>

    ---

    ### Round 5
    <div id="matching-game-5" data-lesson="lesson34_b" data-round="5"></div>

    ---

    ### Round 6
    <div id="matching-game-6" data-lesson="lesson34_b" data-round="6"></div>

    ---

    ### Round 7
    <div id="matching-game-7" data-lesson="lesson34_b" data-round="7"></div>

    ---

    ### Round 8
    <div id="matching-game-8" data-lesson="lesson34_b" data-round="8"></div>

    ---

    ### Round 9
    <div id="matching-game-9" data-lesson="lesson34_b" data-round="9"></div>

    ---

    ### Round 10
    <div id="matching-game-10" data-lesson="lesson34_b" data-round="10"></div>
...
=== "Exercise 2"
    ...
    **If you don't remember or make a mistake, that's totally fine!** We will have plenty of opportunities to practice. Right now just give it a try.
    ...
    ---
    ### Round 1
    <div id="matching-game-11" data-lesson="lesson32_exercise2" data-round="1"></div>

    ---

    ### Round 2
    <div id="matching-game-12" data-lesson="lesson32_exercise2" data-round="2"></div>

    ---

    ### Round 3
    <div id="matching-game-13" data-lesson="lesson32_exercise2" data-round="3"></div>

    ---

    ### Round 4
    <div id="matching-game-14" data-lesson="lesson32_exercise2" data-round="4"></div>

    ---

    ### Round 5
    <div id="matching-game-15" data-lesson="lesson32_exercise2" data-round="5"></div>

    ---

    ### Round 6
    <div id="matching-game-16" data-lesson="lesson32_exercise2" data-round="6"></div>

    ---

    ### Round 7
    <div id="matching-game-17" data-lesson="lesson32_exercise2" data-round="7"></div>

    ---

    ### Round 8
    <div id="matching-game-18" data-lesson="lesson32_exercise2" data-round="8"></div>

    ---

    ### Round 9
    <div id="matching-game-19" data-lesson="lesson32_exercise2" data-round="9"></div>

    ---

    ### Round 10
    <div id="matching-game-20" data-lesson="lesson32_exercise2" data-round="10"></div>

    ---

    ### Round 11
    <div id="matching-game-21" data-lesson="lesson32_exercise2" data-round="11"></div>

    ---

    ### Round 12
    <div id="matching-game-22" data-lesson="lesson32_exercise2" data-round="12"></div>

    ---

    ### Round 13
    <div id="matching-game-23" data-lesson="lesson32_exercise2" data-round="13"></div>
...
function initWarmup() {
    const warmupWords = [
    {id: "yu_y2", oravia: "yugai", english: "easy"},
    {id: "yu_y3", oravia: "yuba", english: "good"},
    {id: "yu_y5", oravia: "yufer", english: "dirty"},
    {id: "yu_n1", oravia: "yunmir", english: "rich"},
    {id: "yu_n3", oravia: "yunpili", english: "timid"},
    {id: "yu_n6", oravia: "yunmpou", english: "lazy"},
    {id: "yu_n7", oravia: "yunrani", english: "beautiful"},
    ];
