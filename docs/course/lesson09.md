...
=== "Grammar"
    ...
    ```
    ceidom rune faibor i bortal?
    ```
    
    ```
    ce haye falen i dai i bocei?
    ```
    ...
    **Tips**
    ...
    <div id="subcluster-answer" style="display: none; background: #c8e6c9; padding: 1.5rem; border-left: 4px solid #43a047; border-radius: 4px; margin: 2rem 0;">
        <p style="margin: 0;"> Possible translations: Where does your spouse enter? What does his child want to decorate? Who are their parents? Where is your table from? What do we need to wash? My son can cook. </p>
    </div>
    
    Now try to create 3 sentences using verb stacking. Remember:
    ```
    i [root] i [verb] 
...
=== "Vocabulary"
    ...
    Recall words are flexible. The **YA** cluster is usually in the role of adjectives, but they can be nouns, verbs, or adverbs as well. For example:
...
=== "Exercise 1"
    ...
    **If you don't remember or make a mistake, that's totally fine!** We will have plenty of opportunities to practice. Right now just give it a try.
    ...
    <div id="matching-game-4" data-lesson="lesson09" data-round="4"></div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    Promise.all([
        ...
        fetch(baseUrl + '/data/lesson08_words.json').then(r => r.json())
    ])
    .then(results => {
