...
=== "Grammar"
    ...
    **IS** is used to mean something that has **not yet started**.  
    ...
    You can attach *ar* and *is* to the end of a word. When we use it on a verb, *ar* means the action has been completed, and *is* means the action has not yet started. The base verb form is the generic form, and in some contexts can be understood as ongoing.
    ...
    <p style="margin: 0 0 0.5rem 0;">Possible translations: litegais, liperiar </p>
    </div>
    ...
    litamar i mo = yesterday I ate
    litamis i mo = tomorrow I will eat
    ```
...
=== "Vocabulary"
    ...
    <p style="margin: 0;"><strong>BE</strong> means <strong>travel!</strong></p></p>
    </div>
    ...
    <p style="margin: 0;">The subcluster is <strong>BEI</strong>, and it means <strong>vehicle</strong>. </p>
    </div>
...
=== "Exercise 2"
    ...
    **If you don't remember or make a mistake, that's totally fine!** We will have plenty of opportunities to practice. Right now just give it a try.
    ...
    <div id="matching-game-7" data-lesson="lesson18" data-round="1"></div>
    
    ---
    
    ### Round 2
    
    <div id="matching-game-8" data-lesson="lesson18" data-round="2"></div>
    
    ---
    
    ### Round 3
    
    <div id="matching-game-9" data-lesson="lesson18" data-round="3"></div>
    
    ---
    
    ### Round 4
    
    <div id="matching-game-10" data-lesson="lesson18" data-round="4"></div>
    
    ---
    
    ### Round 5
    
    <div id="matching-game-11" data-lesson="lesson18" data-round="5"></div>

    ---
    
    ### Round 6
    
    <div id="matching-game-12" data-lesson="lesson18" data-round="6"></div>
...
function initWarmup() {
    const warmupWords = [
    {id: "il_a1", oravia: "ilace", english: "ask"},
    {id: "il_a2", oravia: "ilahai", english: "talk"},
    {id: "il_a3", oravia: "ilaluan", english: "say"},
    {id: "il_i1", oravia: "ilian", english: "know"},
    {id: "il_i2", oravia: "ilie", english: "maybe"},
    {id: "il_i3", oravia: "iliro", english: "think"},
    ];
