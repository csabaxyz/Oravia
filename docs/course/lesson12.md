...
=== "Vocabulary"
    ...
    <div id="cluster-answer" style="display: none; background: #c8e6c9; padding: 1.5rem; border-left: 4px solid #43a047; border-radius: 4px; margin: 2rem 0;">
        <p style="margin: 0;"> **ILA** is about sharing knowledge, **ILI** is about cognition, and **ILO** is about what happens when knowledge is uncertain. </p>
    </div>
...
const warmupWords = [
    {id: "fa_001", oravia: "faibor", english: "companion"},
    {id: "fa_002", oravia: "falni", english: "baby"},
    {id: "fa_003", oravia: "falen", english: "child"},
    {id: "fa_004", oravia: "faejal", english: "man"},
    {id: "fa_005", oravia: "faejor", english: "woman"},
    {id: "fa_006", oravia: "fare", english: "parent"}
];
